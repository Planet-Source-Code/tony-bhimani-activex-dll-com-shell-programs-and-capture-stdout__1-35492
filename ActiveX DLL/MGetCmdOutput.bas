...
' Modification to original source
'
' I made a slight modification to the code
' for the GetCommandOutput method, I added an extra
' parameter.
' -- nShowWindow
' To hide or show the shelled window
'
' Changes made by Tony Bhimani
